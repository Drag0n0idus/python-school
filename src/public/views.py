...
from .forms import LogUserForm, secti,masoform, Prihlaseni
from ..data.database import db
from ..data.models import LogUser, loginData
...
def Prihlasenif():
    form = Prihlaseni()
    if form.validate_on_submit():
        loginData.create(**form.data)
        flash("Thanks for signing up. Welcome!" + form.jmeno.data + form.prijmeni.data, 'info')
    return render_template("public/Prihlaseni.tmpl", form=form)