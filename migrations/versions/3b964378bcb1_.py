...
Revision ID: 3b964378bcb1
Revises: None
Create Date: 2017-10-16 16:31:02.382818

"""

# revision identifiers, used by Alembic.
revision = '3b964378bcb1'
down_revision = None
...
def upgrade():
    ...
    op.create_table('prihlaseni',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('jmeno', sa.String(), nullable=False),
    sa.Column('prijmeni', sa.String(), nullable=False),
    sa.Column('muz', sa.Boolean(name='muz'), nullable=True),
    sa.Column('zena', sa.Boolean(name='zena'), nullable=True),
    sa.PrimaryKeyConstraint('id', name='pk_prihlaseni'),
